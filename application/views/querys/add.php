                        ...
                        <div class="panel-body">
                            <form method="post" action="" class="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="lng" class="form-control" name="lng"  value="">
                                    <?php echo form_error('lng','<p class="text-danger">','</p>'); ?>
                                </div>    
                                <div class="form-group">
                                    <label for="dt">Enter Pickup Date & Time</label>
                                    <input type="text" id="datetimepicker4" class="form-control" name="dt"  value="<?php echo !empty($post['dt'])?$post['dt']:''; ?>">
                                ...
                                <input type="submit" name="querySubmit" class="btn btn-primary" value="Submit"/> </div>
