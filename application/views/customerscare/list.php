            ...
            <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
              ...
              <tbody>
                <?php $i=1;foreach($customers as $customer){ ?>
                 <tr>                  
                  <td widtd="5%"><?php echo $i++;?></td>
                  <td widtd="5%"><?php echo $customer->name;?></td>
                  <td widtd="10%"><?php echo $customer->email;?></td>
                  <td widtd="10%"><?php echo $customer->mobile;?></td>
                  <td widtd="10%"><?php echo $customer->address1;?></td>
                  ...
                  <td><?php  if($customer->status){ echo '<button class="btn"><i class="fa fa-check btn text-success"></i></button>'; } else{ echo '<button class="btn"><i class="fa fa-close text-danger"></i></button>'; } ?></td>
                
                  <td>
                    <button class="btn"><i class="text-danger fa fa-trash" onclick="ConfirmDelete('<?php echo $customer->id;?>')"></i></button>
                    <a href="<?php echo base_url('customer/customerDetail/'.$customer->id);?>" class="btn"><i class="text-success fa fa-clone"></i></a>
                  </td> 
                </tr>
              <?php }?>
              </tbody> 
