                  ...
                  <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="slab" >
                                              <option <?php echo ($post['slab'] == "slab_a")? 'selected':'';  ?> value="slab_a">SLAB A</option>
                                              <option <?php echo ($post['slab'] == "slab_b")? 'selected':'';  ?>  value="slab_b">SLAB B</option>
                                              <option <?php echo ($post['slab'] == "slab_c")? 'selected':'';  ?> value="slab_c">SLAB C</option>
                                              <option <?php echo ($post['slab'] == "slab_d")? 'selected':'';  ?> value="slab_d">SLAB D</option>
                                              <option <?php echo ($post['slab'] == "slab_e")? 'selected':'';  ?> value="slab_e">SLAB E</option>
                                            </select>                        
                                        </div>
                  <!-- /.row -->
                </div>
