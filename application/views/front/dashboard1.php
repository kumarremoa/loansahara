...
<li class="active"><a href="#profile" data-toggle="tab"><img src="<?php echo base_url();?>fronts/images/user.png"> Profile</a>
</li>
...
<ul id="suggestions">
<li><a href="#" data-targetname="" class="email id"><span>15%</span>email id</a>
</li>
<li><a href="#" data-targetname="" class="pan"><span>15%</span>Quicken your process</a>
</li>
<li><a href="#" data-targetname="personalInfo.applicantDetail.maritalStatus" class="marital status"><span>8%</span>marital status</a>
</li>
</ul>
</div>
</div>
...
<img src="fronts/images/home.png">  <a>Profile Updation</a>
</h4>
</div>
<div  class="panel">
...
<form class="form" action="<?php echo base_url('profile-update');?>" method="post" id="cibil_registrationForm">
  ...
  <div class="form-group">
    <div class="col-xs-6">
      ...
      <input type="number" class="form-control1" name="pin" id="pin" placeholder="122001" value="">
    </div>
  </div>
  <div class="col-md-12 submit-button-block js-buttons" data-actionloc="">
...
<form class="form" action="<?php echo base_url('customer-message');?>" method="post" id="ticketing_registrationForm">
  ...
  <div class="form-group">
    <div class="col-xs-6">
      ...
      <input type="text" class="form-control1" name="name" id="ticketing_name" placeholder="First name" title="enter your first name if any." value="<?php echo $profile[0]->name; ?>">
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-xs-6">
      ...
      <input type="text" class="form-control1" name="mobile" id="ticketing_mobile" placeholder="enter mobile number" title="enter your mobile number if any." value="<?php echo $this->session->userdata('mobile');?>" readonly>
    </div>
  </div>
  <div class="form-group">
    <div class="col-xs-6">
      ...
      <input type="text" name="agent" class="form-control1">
    </div>
  </div>
   <div class="form-group">
    <div class="col-xs-6">
      ...
      <input type="text" id="mobile" name="agent_mobile" class="form-control1" maxlength="10">
    </div>
  </div>
  <div class="form-group">
    <div class="col-xs-6">
      ...
      <textarea id="subject" style="width: 90%"name="client_message" class="form-control1" placeholder="Write something..">   
      </textarea>
    </div>
  </div>
  <div class="col-md-12 submit-button-block js-buttons" data-actionloc="">
