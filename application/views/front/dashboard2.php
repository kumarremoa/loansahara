...
<img src="fronts/images/progress.png">  <a>Apply Loan Approvel Report</a>
</h4>
</div>
<div class="panel-body">
  <div class="progress">
            ...
            <span class="progress-type">60% Complete</span>
        </div>
       <div class="">
            <span class="progress-type">Form Apply Check</span> <input type="checkbox" name=""><br>
            <span class="progress-type">Profile Check</span> <input type="checkbox" name=""><br>
            <span class="progress-type">KYC Check</span> <input type="checkbox" name=""><br>
            <span class="progress-type">Cibil Check</span> <input type="checkbox" name=""><br>
            <span class="progress-type">Approved</span> <input type="checkbox" name="">
        </div>
       <!--  <div class="progress">
...
<form class="form" action="<?php echo base_url('customer-employee');?>" method="post" id="employment_registrationForm">
  ...
  <div class="form-group">
    <div class="col-xs-6">
      ...
      <select id="employment_type" class="form-control1" name="emp_occupation">
        <option>Choose...</option>
        <option>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <div class="col-xs-6">
                ...
                <input type="text"style="border: 1px solid #cccccc57;"  id="mobile1" name="agent_mobile" class="form-control1" maxlength="10">
              </div>
            </div>
            <div class="form-group">
              <div class="col-xs-6">
