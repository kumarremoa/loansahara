...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="password" placeholder="Password" required="">
          <?php echo form_error('password','<span class="glyphicon glyphicon-lock form-control-feedback">','</span>'); ?> </div>
          
      <div class="row">
        <div class="col-xs-12">
          <input  type="submit" name="loginSubmit" value="Sign In" class="btn btn-danger btn-block btn-flat">
        </div>
        <!-- /.col -->
      </div>    
    </form>
    <div class="row" style="margin-bottom: -20px;">
        <div class="col-xs-12">
          <p class="pull-right"  style="margin-top: 5px; font-size: 12px;"> <a href="<?php echo base_url('reset'); ?>" target="blank" style="color: #777;"> FORGOT PASSWORD</a></p>
        </div>
        <!-- /.col -->
      </div>
    <div class="clearfix">
   ...
   <div class="row" style="margin-top: -20px;">
        <div class="col-xs-12">
         <h5 class="text-center">Be Distributor or Agent at <?php echo (setting_all('company_name'))?setting_all('company_name'):'Us';?></h5>
          <input  type="submit" name="loginSubmit" value="Register Now" class="btn btn-success btn-block btn-flat">
        </div>
        <!-- /.col -->
      </div> 
  <!-- /.login-box-body -->
