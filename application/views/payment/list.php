              ...
              <tbody>
               ...
               <tr>
                <td><?php echo $i++;?></td>
                 ...
                 <td>
                  <a href="<?php echo base_url('payment/transaction/'.$customer->id); ?>" class="btn btn-success">Payment</a> 
                    <?php if($customer->parent_id == 1 && $this->session->userdata('id')!=1) {?>
                      <a href="#" class="btn btn-info">Loan Confirmed </a> 
                   <?php } else { ?>
                      <a href="<?php echo base_url('payment/approved/'.$customer->id); ?>" class="btn btn-info">Loan Approved</a>
                  <?php } ?>
                  </td>
               </tr>
             <?php endforeach;?>
...
$(document).ready(function() {
        $('#aht_btn').click(function(event){
          ...
          if(agent!=0){
            $.ajax({
            type:"POST",
            url : "<?php echo base_url('payment/agentSelect');?>",
