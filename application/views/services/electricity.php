			...
			<div class="col-xs-12">
	            <div class="box box-info">
	                <div class="box-header with-border">
	                  <h3 class="box-title hidden-print">Electricity Bill Payment - By: <?php echo !empty($user['name'])?$user['name']:'User'; ?>
	                ...
	                <div class="box-body" >	
						<div id="mtval">
			               	...
			               	<div class="col-md-4 table-bordered" id="senderMobile">	
			               		<h3 class="text-center">Electricity Bill Payment</h3><hr>
			               		<div class="form-group col-md-12">
			                        <select class="form-control select2" id="operator" name="operator" onchange="return getOperatorCity()"></select>
			                    </div>
			                    <div id="citylist">
			                    </div> 
			                    <div id="citylistd">
