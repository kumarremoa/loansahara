			...
			<div class="col-xs-12">
	            <div class="box box-info">
	                <div class="box-header with-border">
	                  <h3 class="box-title hidden-print">Postpaid Mobile Recharge - By: <?php echo !empty($user['name'])?$user['name']:'User'; ?>
	                ...
	                <div class="box-body" >	
						<div id="mtval">
			               	...
			               	<div class="col-md-4 table-bordered" id="senderMobile">	
			               		<h3 class="text-center">Postpaid Recharge</h3><hr>
								<div class="form-group col-md-12">
			                        <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Enter Mobile No..." value="">  
			                    </div>
			                    <div class="form-group col-md-12">
			                    ...
			                    <div class="form-group col-md-12">
			                        <input type="submit" name="checkUser" id="rechargePostpaid" class="btn btn-primary btn-flat btn-block" value="Submit"/> 
			                    </div>			                    
			                </div>              
			               	<div class="col-md-4"></div> 
