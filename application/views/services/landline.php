			...
			<div class="col-xs-12">
	            <div class="box box-info">
	                <div class="box-header with-border">
	                  <h3 class="box-title hidden-print">Landline Bill Payment - By: <?php echo !empty($user['name'])?$user['name']:'User'; ?>
	                ...
	                <div class="box-body" >	
						<div id="mtval">
			               	...
			               	<div class="col-md-4 table-bordered" id="senderMobile">	
			               		<h3 class="text-center">Landline Bill Payment</h3><hr>
			               		<div class="form-group col-md-12">
			                        <select class="form-control select2" id="operator" name="operator"></select>
			                    </div>								
			                    <div class="form-group col-md-12">
			                        <input type="text" class="form-control" id="std_code" name="std_code" placeholder="Enter STD code..." value="">  
			                    </div>
			                    <div class="form-group col-md-12">
			                        <input type="text" class="form-control" id="landline_no" name="landline_no" placeholder="Enter Landline No..." value="">  
			                    </div>
			                     <div class="form-group col-md-12">
			                        <input type="text" class="form-control" id="account" name="account" placeholder="Enter Account No..." value="">  
			                    </div>			                    
			                    <div class="form-group col-md-12">
			                        <input type="text" class="form-control" id="amount" name="amount" placeholder="Enter Amount..." value="">  
			                    </div>
			                    <div class="form-group col-md-12">
			                        <input type="submit" name="checkUser" id="rechargeLl" class="btn btn-primary btn-flat btn-block" value="Submit"/> 
			                    </div>			                    
			                </div>              
			               	<div class="col-md-4"></div> 
